(() => {
    var e = {
        ...
        colors: ["#3366ff"],
        chart: {id: "area-datetime", type: "area", height: 300, zoom: {autoScaleYaxis: !0}},
        annotations: {
            yaxis: [{
                y: 30,
                borderColor: "rgba(180, 183, 197, 0.4)",
                label: {show: !0, text: "Support", style: {color: "#fff", background: "#00E396"}}
            }],
            xaxis: [{
                x: new Date("14 Nov 2012").getTime(),
                borderColor: "rgba(180, 183, 197, 0.4)",
                yAxisIndex: 0,
                label: {show: !0, text: "Rally", style: {color: "#fff", background: "#775DD0"}}
            }]
        },
    ...
    new ApexCharts(document.querySelector("#chart-timeline"), e).render();
    ...
    var a = {
        ...
        }, {name: "Tank Picture", data: [22, 27, 21, 29, 15, 21, 20]}, {
            name: "Bucket Slope",
            data: [25, 12, 19, 32, 25, 24, 10]
        }, {name: "Reborn Kid", data: [9, 7, 5, 8, 6, 9, 4]}],
        colors: ["#3366ff", "#01c353", "#ffad00", "#fe7f00", "#f11541"],
        chart: {type: "bar", height: 300, stacked: !0},
        plotOptions: {bar: {horizontal: !0}},
        ...
        fill: {opacity: 1},
        legend: {show: !1, position: "top", horizontalAlign: "left", offsetX: 40}
    };
    new ApexCharts(document.querySelector("#chart3"), a).render();
    new ApexCharts(document.querySelector("#chart5"), {
        ...
        legend: {show: !1},
        hover: {mode: null},
        responsive: [{breakpoint: 480, options: {chart: {width: 200}, legend: {show: !1, position: "bottom"}}}]
    }).render();
    new ApexCharts(document.querySelector("#chart6"), {
        series: [{name: "Series 1", data: [80, 50, 30, 40, 100, 20]}],
        plotOptions: {radar: {polygons: {strokeColor: "#D3DFEA", fill: {colors: ["#f3f4f7", "#fff"]}}}},
        colors: ["#3366ff"],
    ...
    new ApexCharts(document.querySelector("#chart7"), {
        ...
        colors: ["#3366ff", "#01c353", "#ffad00", "#fe7f00", "#f11541"],
        chart: {height: 300, type: "radar", dropShadow: {enabled: !0, blur: 1, left: 1, top: 1}},
        stroke: {width: 2},
        fill: {opacity: .4},
        markers: {size: 0},
        ...
        plotOptions: {
            radialBar: {
                dataLabels: {
                    ...
                    value: {fontSize: "16px"},
                    total: {
                        show: !1, label: "Total", formatter: function (e) {
                            return 249
                        }
                    }
                }
