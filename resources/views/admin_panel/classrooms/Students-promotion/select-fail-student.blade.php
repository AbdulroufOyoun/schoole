...
<div class="card">
    <form id="deposition-form" method="POST" action="{{ route('classrooms.deposition') }}">
        @csrf
        <div class="card-header border-bottom-0">
            <h3 class="card-title">@lang('classroom.deposition_select_student')</h3>
            <button type="submit" class="btn btn-danger ml-auto"
            onclick="return confirm('@lang('alert.confirm_deposition')')">@lang('classroom.deposition_submit')</button>
        </div>
